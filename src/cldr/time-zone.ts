/**
 * Backward compatibility time zone identifiers.
 *
 * Kinds of zones included here are:
 *   - links (aliases),
 *   - legacy/deprecated names.
 *
 * ---
 *
 * File: [DBRelease]/backward
 *
 * @see https://www.iana.org/time-zones Official website
 * @see https://data.iana.org/time-zones/releases/tzdata2025b.tar.gz Release: tzdata2025b
 */
export const IANABackwardTimeZoneList = [
    //
    'UTC',
    'GMT',
] as const;
...
/**
 * Etcetera time zone identifiers.
 *
 * ---
 *
 * File: [DBRelease]/etcetera
 *
 * @see https://www.iana.org/time-zones Official website
 * @see https://data.iana.org/time-zones/releases/tzdata2025b.tar.gz Release: tzdata2025b
 */
export const IANAEtcTimeZoneList = [
    //
    'Etc/UTC',
    'Etc/GMT',
] as const;
 ...
 *   (backward-compatible zones included).
 *
 * ---
 *
 * File: [DBRelease]/zone.tab
 *
 * @see https://www.iana.org/time-zones Official website
 * @see https://data.iana.org/time-zones/releases/tzdata2025b.tar.gz Release: tzdata2025b
 */
export const IANATimeZoneList = [
    ...IANABackwardTimeZoneList,
